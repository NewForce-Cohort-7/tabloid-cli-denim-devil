...
namespace TabloidCLI.UserInterfaceManagers
{
    public class JournalManager : IUserInterfaceManager
    {
        ...
        private Repositories.JournalRepository _journalRepository;
        private string _connectionString;

        public JournalManager(IUserInterfaceManager parentUI, string connectionString)
        {
            _parentUI = parentUI;
            _journalRepository = new Repositories.JournalRepository(connectionString);
        ...
        private void Remove()
        {
            ...
            Console.WriteLine("Journal deleted successfully!");
        }
    }
}
